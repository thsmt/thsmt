...
AWS認定の取得状況はCredlyで、横断的な運用手順やツール操作のメモはGitHub Pagesで整理しています。各リポジトリには構成単位の成果物を置き、GitHub PagesにはCloudFormation、AWS CLI、Terraform、AWX / Ansibleなどの共通手順をまとめています。
